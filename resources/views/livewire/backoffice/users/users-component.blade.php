<div class="container mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('usuarios.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md inline-flex items-center">
    ...
    @include('backoffice.usuarios.table', ['usuarios' => $usuarios])
    ...
    @endif
    <div wire:loading.delay.shortest wire:target="delete" class="fixed inset-0 flex items-center justify-center bg-white bg-opacity-75 z-50">
        <x-spinner />
    </div>
</div>
<script>
